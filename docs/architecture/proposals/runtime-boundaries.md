...
| 근거 | 코드 또는 문서 | 확인한 사실 |
| --- | --- | --- |
| E1 공통 실행 경로 | [core.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/core.py), [main.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/main.py), [mcp_facade.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/mcp_facade.py) | `execute_call`(core 977행)에 REST(main 284-288행), MCP facade(43-78행), Agent와 승인 후 실행이 수렴한다 |
| E2 실행과 증적 저장 순서 | [agent_gateway.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/agent_gateway.py), [core.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/core.py), [실행 경계 설명](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/docs/runtime-hardening.md) | Agent receipt(34-64행), 승인 claim(core 1225-1231행)은 존재한다. upstream 호출(1171행) 뒤 감사(1209행), 승인 최종 상태(1237-1241행)를 저장한다 |
| E3 공용 DB 역할과 기동 DDL | [compose.yaml](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/compose.yaml), [db.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/db.py), [agent_tables.sql](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/agent_tables.sql) | Gateway, SSE, Agent, Worker가 `mcp` 역할을 공유한다. Gateway bootstrap(core 387-390행)과 Agent lifespan(agent_service 70-75행)이 DDL을 수행한다. 감사 trigger는 있으나 앱 역할이 schema owner임을 SQL 57-60행이 명시한다 |
| E4 실습 오버레이의 추가 권한 | [compose.corporate-lab.yaml](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/compose.corporate-lab.yaml) | 기본 구성과 달리 A.I.G를 Gateway 컨테이너에서 실행하고 `SYS_ADMIN`, `seccomp:unconfined`, scanner 망을 추가한다(1-31행) |
| E5 정책과 공용 유틸의 결합 | [core.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/core.py), [replay.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/replay.py), [agent_service.py](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/gateway/app/agent_service.py) | Agent와 replay가 해시/Schema를 위해 core를 import한다. core 125행은 import 시 tracing을 구성한다. bootstrap은 policy.rego 해시를 기록하고, 관리대장 캐시는 명시적 refresh 전까지 유지한다(675-694행) |
| E6 이미 있는 검증과 한계 | [현재 반영 기록](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/docs/PDF-INTEGRATION-2026-09.md), [통제 평면](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/full_stack_lab/CONTROL_PLANES.md), [CI](https://github.com/MCP-governance/mcp-gateway/blob/45b9f6ed6dd9cb6b6eadfaf2b6cc6ee1ac377967/.github/workflows/verify.yml) | Presidio, 감사 체인 v5, 정책만 재생하는 후보 OPA, 장치 자격, 내부망 검사와 전체 acceptance 실행 절차가 있다 |
